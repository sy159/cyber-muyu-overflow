...
async function main() {
  ...
  assert(background.includes("有钱 +1"), "random rewards should include money-themed copy");
  ...
  assert(background.includes("白嫖 +1"), "random rewards should include free-riding copy");
  ...
  assert(getCssBlock(styles, "@keyframes cyberMuyuHammerKnock").includes("rotate(20deg)"), "hammer must snap down hard at the impact frame");
  assert(getCssBlock(styles, "@keyframes cyberMuyuBowlKnock").includes("scale3d(1.15, 0.8, 1)"), "bowl must squash on the impact frame");
